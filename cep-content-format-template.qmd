...
::: page-note
*(All pages in the front matters will have **1.5 inch margin** on the **left** side and 1.0 inch margins on the top, right, and bottom of a page)*
:::

::: {.callout-note .hl-yellow}
## Instructions on the Title Page

-   This page should be one page long and include Project Title, appropriate description, the names of all team members, faculty advisor(s), and affiliation.

-   Follow the format of [the template](https://docs.google.com/document/d/1Pv5wn9QUTmBgrY2H_9R4-MrDewLz7qaZ/edit).
...
::: page-note
(This page should include Project Title, the names of all team members, and faculty advisor(s)). Download [the template](https://docs.google.com/document/d/1Pv5wn9QUTmBgrY2H_9R4-MrDewLz7qaZ/edit) and just replace it with your own information. Below is how it should look like.
:::
...
This is where students may acknowledge important people in their life that impacted their graduate studies, such as family members, mentors, and friends. Below is a space holder.
:::
...
::: page-note
*(The abstract should be no more than **250 words** including section headings and keywords.)*
:::

::: {.callout-note .hl-yellow}
## Instructions for Abstract

-   **Do not write this section** until the end of the CEP journey in the summer semester when you have a clear understanding of your contributions to the project. You can refer to the sample summary of individual contribution in the [**template document**](https://docs.google.com/document/d/1Pv5wn9QUTmBgrY2H_9R4-MrDewLz7qaZ/edit) for guidance on how to write your own summary.

-   The abstract should be structured with the appropriate sub-headings.
...
-   The below sub-headings are optional and can be included, if applicable:
...
-   **Article keywords**:\
    Your submission should include **up to 6 appropriate and short keywords** that capture the key topics of the paper. Choosing the right key words can help enhance the online discoverability of your research and may also be used to help find relevant reviewers.

-   Below is a sample of an abstract screenshot from a published CEP on BroncoWorks library repository.
:::
...
::: page-note
*(Each individual contribution statement should be between **75 words and 100 words**.)*
:::

::: {.callout-note .hl-yellow}
## Instructions for Summary of Individual Contribution
...
::: {.callout-note .hl-yellow}
-   Sometimes you will be presented with project objectives (PO), instead of analytics objectives (AO), in which case, you must translate the project objectives (marketing or business objectives) into analytics objectives.

-   For more information on [how to tell difference between AO's and PO's](capstone_project.qmd#project-objectives-po-vs.-analytics-objectives-ao-1) and [how to convert PO’s to AO’s](capstone_project.qmd#how-to-convert-po-to-ao), follow the links.
:::
...
::: callout-tip
### Assessment Rubric for SLO 1: Translate a marketing problem into research questions or hypotheses that will drive the research project.
...
### AO1. Title of AO1 (Name of Student 1) {#sec-ao1-title-ao1}
...
Gu et al. [-@gu2024] examines how characteristics of AI-generated advertisements influence consumer acceptance through perceived eeriness and perceived intelligence and show that different ad features shape these perceptions in opposite ways, offering practical guidance for advertisers using generative AI. As consumers are ultimate judges for effectiveness of AI-generated contents [@gu2024], past research that examined consumer reactions to technology will be relevant [e.g., @reich2022; @wu2021]

::: callout-note
#### Citation Syntax Explanation
